<template>
  <GameEventWithTexts
    id="game-scapegoat-turn-starts-event"
...
const gameEventTexts = computed<string[]>(() => [t("components.GameScapegoatTurnStartsEvent.scapegoatCanBanPlayerFromVoting")]);

playSoundEffect("goat-cry");
</script>