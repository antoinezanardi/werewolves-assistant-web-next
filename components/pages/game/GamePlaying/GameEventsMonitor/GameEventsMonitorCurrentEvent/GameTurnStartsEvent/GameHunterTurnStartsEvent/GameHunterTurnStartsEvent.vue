<template>
  <GameEventWithTexts
    id="game-hunter-turn-starts-event"
...
const gameEventTexts = computed<string[]>(() => [t("components.GameHunterTurnStartsEvent.hunterShootsAtPlayer")]);

playSoundEffect("gun-shot");
</script>