...
const gameEventTexts = computed<string[]>(() => [
  t("components.GameStutteringJudgeTurnStartsEvent.stutteringJudgeCanRequestAnotherVote"),
  t("components.GameStutteringJudgeTurnStartsEvent.everyonePutHandsInBackAndGameMasterWillRecognizeSign"),
]);
</script>