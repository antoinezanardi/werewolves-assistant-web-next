<template>
  <GameEventWithTexts
    id="game-accursed-wolf-father-turn-starts-event"
...
const gameEventTexts = computed<string[]>(() => [t("components.GameAccursedWolfFatherTurnStartsEvent.accursedWolfFatherCanInfect")]);
