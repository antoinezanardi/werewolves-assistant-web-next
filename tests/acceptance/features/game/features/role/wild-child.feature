...
Feature: 🐒 Wild Child Role
  ...
  Scenario: 🐒 Wild Child transformation is revealed to everyone when game master sets it in game options
    ...
    When the user goes to the next game event text
    Then the game's event should display the text "Special rule 2 : When the Wild Child becomes a Werewolf as his model dies, the Game Master reveals his transformation to the other players."
