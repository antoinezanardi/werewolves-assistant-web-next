  ...
  describe("Sections", () => {
    ...
    it("should translate second section when rendered.", () => {
      ...
      expect(secondSection.text()).toBe("For me, Werewolves of Miller's Hollow™ game is one of the best games to play with friends or " +
        ...
        "As the game progresses, the true nature of each player is revealed, masks fall, and everyone feels threatened. " +
        "Each game is a unique adventure, full of unexpected twists.");
    });
